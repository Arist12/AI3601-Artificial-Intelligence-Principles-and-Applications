...
if config["print_result"]:
    ...
    ax.plot(x, episode_rewards, color='blue', linestyle='-', linewidth=1.0, alpha=0.8)
    ...
    plt.tight_layout()
    plt.savefig('qlearning_1.png',bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('qlearning_2.png',bbox_inches='tight')
    plt.show()
##### END CODING HERE #####
